...
ActiveRecord::Schema.define(version: 2021_03_01_234650) do
  ...
  create_table "leagues", id: :uuid, default: -> { "gen_random_uuid()" }, force: :cascade do |t|
    ...
    t.string "aasm_state"
    t.uuid "user_id"
    t.integer "current_draft_position", default: 1, null: false
    t.boolean "draft_forward", default: true, null: false
  ...
  create_table "teams", id: :uuid, default: -> { "gen_random_uuid()" }, force: :cascade do |t|
    ...
    t.index ["league_id", "draft_position"], name: "index_teams_on_league_id_and_draft_position", unique: true
